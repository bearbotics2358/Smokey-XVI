    ...
    switch (a_AutoState0) {
        case kBlueAutoIdle0:
         ...
         case kBlueExtend0:
            ...
            if(a_Claw -> TransformClaw(160, 500, true)){
                state_time = gettime_d();
            ...
            break;
        case kBlueDrop0:
            a_Claw->TransformClaw(185, 500, true);
            if(gettime_d() > state_time + 6){
                state_time = gettime_d();
                a_Claw->ClawOpen();
...
void Autonomous::PeriodicBCSL() {
    ...
    switch (a_AutoState1) {
        ...
        case kBlueDriveAway1:
            a_Claw->TransformClaw(125, -15, false);
            if (DriveDirection(3.5052, 0, 0.25, true)) {
...
void Autonomous::PeriodicBCSM() {
    ...
    switch (a_AutoState3) {
        ...
        case kBlueDriveAway3:
            a_Claw->TransformClaw(125, -15, false);
            if (DriveDirection(3.5052, 0, 0.4, true)) {
